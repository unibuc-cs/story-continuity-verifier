...
The local `tools/NuSMV/` directory is ignored by Git because it contains third-party binaries. For the validation reported in this artefact, NuSMV was downloaded from the official NuSMV distribution site and checked against the official `.sha256sum` before extraction.
